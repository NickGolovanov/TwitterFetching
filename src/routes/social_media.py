...
social_media_model = ns.model('SocialMedia', {
    'social_media_id': fields.String(required=True, description='Social media identifier'),
    'platform': fields.String(description='Social media platform name'),
    'account': fields.String(description='Account details'),
    # Add other fields that exist in your SocialMedia table
})
